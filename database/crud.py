...
def main():
    ...
    markdown_text = input("Please enter the markdown version of the article (optional): ") or None
    ...
    markdown_file = input("Please enter the path to the markdown file (optional): ") or None
