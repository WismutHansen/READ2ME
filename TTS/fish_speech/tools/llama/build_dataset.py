...
from TTS.fish_speech.fish_speech.datasets.protos.text_data_pb2 import (
    Semantics,
    Sentence,
    TextData,
)
from TTS.fish_speech.fish_speech.datasets.protos.text_data_stream import pack_pb_stream
