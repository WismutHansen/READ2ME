...
from styletts2 import ljspeechimportable
...
async def synthesize_text_to_speech(url: str):
    ...
    try:
        ...
        audios = []
        for t in tqdm(texts):
            audios.append(ljspeechimportable.inference(t, noise, diffusion_steps=5, embedding_scale=1))
